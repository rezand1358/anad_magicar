...
class RestDatasource extends BaseRest {
  ...
  static final BASE_OPEN_ROUTE_SERVICE_URL='https://api.openrouteservice.org/v2/directions/driving-car/geojson';
  ...
  static final GetRelatedUser_URL=BASE_URL+ BASE_RELATED_USER_CAR_URL+"/GetRelatedUsers";
  ...
  static final GET_CARMODEL_BY_ID_URL = BASE_URL + BASE_CARMODEL_URL+ "/GetById";
  static final GET_CARMODEL_BY_BRANDID_URL = BASE_URL + BASE_CARMODEL_URL+ "/GetByBrandId";
  static final GET_CAR_MODEL_DETAIL_URL= BASE_URL+BASE_CARMODEL_DETAIL_URL+ "/GetAll";
  static final GET_CAR_MODEL_DETAIL_BY_ID_URL= BASE_URL+BASE_CARMODEL_DETAIL_URL+ "/GetById";
  static final GET_CAR_MODEL_DETAIL_BY_CARMODEL_ID_URL= BASE_URL+BASE_CARMODEL_DETAIL_URL+ "/GetByCarModelId";
  static final GET_DEVICE_INFO_URL = BASE_URL +BASE_DEVICE_URL+ "/SaveDeviceInfo";
  static final GET_DEVICE_MODEL_URL = BASE_URL + BASE_DEVICE_URL+ "/GetDeviceModel";
  ...
  static final GET_ACTIONS_TO_ROLE_URL = BASE_URL + BASE_ACTION_TO_ROLE_URL+ "/GetAll";
  static final GET_CARS_URL=BASE_URL+BASE_CAR_URL+'/GetAll';
  static final GET_APPROLES_URL = BASE_URL + BASE_ROLE_URL+ "/GetAll";
  static final GET_ACTIONS_TYPES_URL = BASE_URL + BASE_ACTIONS_URL+ "/GetActionTypes";
  static final GET_ACTIONS_BY_ID_URL =BASE_URL+GET_ACTION_BY_ID+  "/GetByActionId";
  static final GET_DEVICE_BY_ID_URL = BASE_URL + BASE_DEVICE_URL+ "/GetById";
  static final GET_ACTIONTOROLE_BY_ROLEID_URL = BASE_URL + BASE_ACTION_TO_ROLE_URL+ "/GetByRoleId";

  static final GET_ADMIN_CARS_BY_USERID_URL= BASE_ADMIN_CAR_URL+ "/GetAdminCarByUserId";
  static final GET_CARS_BY_USERID_URL= BASE_ADMIN_CAR_URL+ "/GetByUserId";
  static final GET_INVOICE_PRIMARY_SAVE_URL=BASE_URL+BASE_INVOICE_URL+'/PrimarySaveInvoice';
  static final GET_INVOICE_PARTIAL_SAVE_URL=BASE_URL+BASE_INVOICE_URL+'/PartialSaveInvoice';
  static final GET_INVOICE_PLAN_ACTIVATION_SAVE_URL=BASE_URL+BASE_INVOICE_URL+'/InvoicePlanActivation';
  static final GET_INVOICE_BY_USERID_URL=BASE_URL+BASE_INVOICE_URL+'/getByUserId';
  ...
  static final ChangeCarToUserStatus_URL=BASE_URL+BASE_CAR_TO_USER_URL+'/ChangeCarToUserStatus';
  static final AcceptRequestByAdmin_URL=BASE_URL+BASE_USER_POLICY_URL+'/AcceptRequest';

  static final LogoutUser_URL=BASE_URL+BASE_USER_URL+'/Logout';
  static final ChangeUserRole_URL=BASE_URL+BASE_USER_POLICY_URL+'/ChangeUserRole';
  static final SetUserNotificationToken_URL=BASE_URL+BASE_USER_URL+'/SetUserNotificationToken';
  static final EditMagicarUser_URL=BASE_URL+BASE_USER_URL+'/EditMagicarUser';
  ...
  static final SaveServiceType_URL=BASE_URL+BASE_SERVICETYPE_URL+'/SaveServiceType';
  ...
  Future<List<SaveUserModel>> getUserInfo(String userId) async{
    ...
    Map<String,int> params={
      ...
      return _netUtil.post(GetUserInfo_URL,body: params).then((res) {
        return  res.map<SaveUserModel>((u)=> SaveUserModel.fromJsonForResultUserInfo(u)).toList();
    });
  ...
  Future<List<ApiRelatedUserModel>> getRelatedUser(String userId) async{
    ...
    return _netUtil.post(GetRelatedUser_URL,body: params).then((res) {
      if(res!=null &&
       res.length>0)
        return  res.map<ApiRelatedUserModel>((u)=> ApiRelatedUserModel.fromJson(u)).toList();
      else
        return null;
    });
  ...
  Future<ServiceResult> changeCarToUserStatus(int userId,
      int carId,
      int statusId) async {
  ...
  Future<List<CurrentUserAccessableActionModel>> getGetCurrentUserAccessableActions(int userId) async{
    Map<String,int> params={
      "UserId": userId,
    };
    return _netUtil.post(GetCurrentUserAccessableActions_URL,/*body: params*/).then((res) {
      if(res!=null &&
          res.length>0)
        return  res.map<CurrentUserAccessableActionModel>((u)=>
            CurrentUserAccessableActionModel.fromJson(u)).toList();
      else
        return null;
    });
  }
  Future<ServiceResult> forgotPassword(SaveUserModel userModel) async{
    return _netUtil.post(ForgetPassword_URL,body: userModel.toJsonForForgotPassword() ).then((res) {
      if(res!=null)
        return  ServiceResult.fromJson(res);
      else
        return null;
  ...
  Future<ServiceResult> editUserProfile(SaveUserModel userModel) async{
    return _netUtil.post(EditMagicarUser_URL,body: userModel.toJsonForEdit() ).then((res) {
      if(res!=null)
        return  ServiceResult.fromJson(res);
      else
        return null;
  ...
  Future<ServiceResult> editCarInfo(SaveCarModel carModel) async{
    return _netUtil.post(ChangeUserRole_URL,body: carModel.toJsonForEdit()).then((res) {
      if(res!=null)
        return  ServiceResult.fromJson(res);
      else
        return null;
  ...
  Future<ServiceResult> changeUserRole(UserRoleModel userRoleModel) async{
    return _netUtil.post(ChangeUserRole_URL,body: userRoleModel.toJson()).then((res) {
      if(res!=null)
        return  ServiceResult.fromJson(res);
      else
        return null;
  ...
  Future<ServiceResult> checkDeviceAvailable(ApiDeviceModel model) async{
    return _netUtil.post(CHECK_DEVICE_AVAILABLE_URL, body: model.toJsonForCheckAvailable() )
        .then(( res) {
      return ServiceResult.fromJson(res);
    });
  }
  ...
  Future<BrandModel> getAllBrands() async{
    return _netUtil.post(GET_BRANDS_URL,).then(( res) {
      return BrandModel.fromJson(res);
    });
  }

  Future<SaveCarModel> getAllColors() async{
    return _netUtil.post(GET_CAR_COLORS_URL,).then(( res) {
      return SaveCarModel.fromJsonForColor(res);
    });
  }
  Future<SearchCarModel> searchCar(SearchCarModel searchModel) async{
    return _netUtil.post(SEARCH_CAR_URL,body: searchModel.toJsonForSendSearchModel()).then(( res) {
  ...
  Future<List<ApiRoute>> getLastPositionRoute(ApiRoute route) async{
    return _netUtil.post(Get_LASTPOSITION_URL,body: route.toJsonLastPosition()).then(( res) {
      if(res!=null)
        return  res.map<ApiRoute>((r)=> ApiRoute.fromJsonLastPositionResult(r)).toList();
      else
        return null;
    });
  }
  Future<List<AdminCarModel>> getAllCarsToAdmin(int userId) async{
    ...
    Uri uri = Uri.http( BASE_URL_GET_WITH_URI, GET_ADMIN_CARS_BY_USERID_URL, params);
    return _netUtil.getUri(uri,).then((res) {
      try {
        if (res != null && res.length>0)
          return res.map<AdminCarModel>((c) => AdminCarModel.fromJson(c)).toList();
      }
      catch(error) {
        return null;
      }
  ...
  Future<List<AdminCarModel>> getAllCarsByUserId(int userId) async {
    ...
    return _netUtil.getUriWithCooki(uri).then((res) {
      try {
        if (res != null ) {
          return res.map<AdminCarModel>((c) => AdminCarModel.fromJsonForUser(c))
              .toList();
  ...
  Future<ServiceResult> deletePairedCars(int masterCarId,List<int> carIds) async{
    ApiPairedCar pairedCar=new ApiPairedCar(MasterCarId: masterCarId, CarIds:carIds );
    return _netUtil.post(DeletePairedCar_URL,body: pairedCar.toJsonForDeletePairedCars()).then((res) {
      try {
        if (res != null) {
          return ServiceResult.fromJson(res);
        }
  ...
  Future<List<InvoiceModel>> getInvoiceByUserId(int userId) async{
    ...
    return _netUtil.post(GET_INVOICE_BY_USERID_URL,body: params).then((res) {
      try {
        if (res != null && res.length>0)
          return res.map<InvoiceModel>((c) => InvoiceModel.fromJson(c)).toList();
      }
      catch(error) {
        return null;
      }
  ...
  Future<ServiceResult> sendFCMToken(int userId,String token) async{
    ...
    return _netUtil.post(SetUserNotificationToken_URL,body: params).then((res) {
      try {
        if (res != null)
          return ServiceResult.fromJson(res);
      }
  ...
  Future<ServiceResult> primarySaveInvoice(int invoiceId) async{
    ...
    return _netUtil.post(GET_INVOICE_PRIMARY_SAVE_URL,body: params).then((res) {
      try {
        if (res != null && res.length>0)
          return  ServiceResult.fromJson(res);
      }
  ...
  Future<List<ApiService>> getCarService(int carId) async{
    ...
    return _netUtil.postWithParams(GetCarService_URL,body: params).then((res) {
      try {
        if (res != null && res.length>0)
  ...
  Future<List<ApiMessage>> getUserMessage() async{
    ...
    return _netUtil.post(GetUserMessage_URL,).then((res) {
      try {
        if (res != null && res.length>0)
  ...
  Future<ServiceResult> sendMessage( ApiMessage message) async{
    ...
    return _netUtil.post(SendMessage_URL,body: message.toJsonForSendMessage()).then((res) {
      try {
        if (res != null && res.length>0)
          return  ServiceResult.fromJson(res);
      }
  ...
  Future<List<ServiceType>> getCarServiceTypes() async{
    ...
    return _netUtil.post(GetServiceTypes_URL,).then((res) {
      try {
        if (res != null && res.length>0)
  ...
  Future<ServiceResult> partialSaveInvoice(int userId,int planId) async{
    ...
    return _netUtil.post(GET_INVOICE_PARTIAL_SAVE_URL,body: params).then((res) {
      try {
        if (res != null && res.length>0)
          return  ServiceResult.fromJson(res);
      }
  ...
  Future<ServiceResult> invoicePlanActivation(int invoiceId,String date) async{
    Map<String,dynamic> params={
      "InvoiceId": invoiceId,
      "ActiveDate": date
    };

    return _netUtil.post(GET_INVOICE_PLAN_ACTIVATION_SAVE_URL,body: params).then((res) {
      try {
        if (res != null && res.length>0)
          return  ServiceResult.fromJson(res);
      }
  ...
  Future<ServiceResult> logoutUser() {
    return _netUtil.get(LogoutUser_URL,).then((res) {
      try {
        if (res != null )
          return ServiceResult.fromJson(res);
      }
  ...
  Future<List<Car>> getAllCars(int userId) async{
    ...
    return _netUtil.get(GET_CARS_URL,).then((res) {
      try {
        if (res != null && res.length>0)
  ...
  Future<List<ActionToRoleModel>> getAllActionsToRole() async{
    return _netUtil.get(GET_ACTIONS_TO_ROLE_URL,).then((res) {
      return res.map<ActionToRoleModel>((c)=> ActionToRoleModel.fromJson(c)).toList();
    });
  }
  Future<ApiCarModel> getAllCarModels() async{
    return _netUtil.post(GET_CAR_MODELS_URL,).then(( res) {
      return ApiCarModel.fromJson(res);
    });
  }

  Future<List<Role>> getAllRoles() async{
    return _netUtil.get(GET_APPROLES_URL,).then(( res) {
      return res.map<Role>( (d) =>Role.fromJson(d)).toList();
    });
  }

  Future<List<ActionModel>> getAllActions() async{
    return _netUtil.get(GET_ACTIONS_URL,).then(( res) {
      return res.map<ActionModel>( (d) =>ActionModel.fromJson(d)).toList();
    });
  }
  Future<List<ApiResultConstant>> getAllActionTypes() async{
    return _netUtil.get(GET_ACTIONS_TYPES_URL,).then(( res ) {
      return res.map<ApiResultConstant>( (d) =>ApiResultConstant.fromJson(d)).toList();
    });
  }
  ...
  Future<ActionModel> getActionToRoleById(int roleId) async{
    ...
    return _netUtil.post(GET_ACTIONTOROLE_BY_ROLEID_URL,body: params).then((res) {
      return res.map((c)=> ActionModel.fromJson(c));
    });
  }

  Future<ServiceResult> assignRoleToCar(AssignRoleToCar model) async{
    return _netUtil.post(ASSIGN_ROLE_TO_CAR_URL,body: model.toJson()).then(( res) {
      return ServiceResult.fromJson(res);
    });
  }

  Future<List<InvoiceModel>> getAllInvoices() async{
    return _netUtil.get(GET_INVOICE_ALL_URL,).then(( res) {
      if(res!=null &&
          res.length>0)
  ...
  Future<List<DeviceModel>> getAllDeviceModels() async{
    return _netUtil.get(GET_DEVICE_MODEL_URL,).then(( res) {
      if(res!=null &&
        res.length>0)
  ...
  Future<User> authenticate(String username, String password) async{
    return _netUtil.post<User>('AUTHENTICATE_URL', body: {
      "username": username,
      "password": password
    }).then((User res) {
      //print(res.toString());
  ...
  Future<SaveMagicarResponeQuery> register({Map<String,dynamic> body} ) async {
    ...
    return _netUtil.postNoCookie(SAVE_USER_MAGICAR_URL, body: body,).then(( res) {
  ...
  Future<dynamic> editProfile({Map<String,dynamic> body} ) async{
    ...
    return _netUtil.post<dynamic>('EDITPROFILE_URL', body: body,headers: headers
    ).then((dynamic res) {
      return res;
    });
  }
  ...
  Future<dynamic> fetchOpenRouteServiceURlJSON({dynamic body} ) async{
    ...
    Map<String,String> headers=new Map();
    headers.putIfAbsent("Content-Type",()=> content);
    headers.putIfAbsent('Authorization', ()=>'5b3ce3597851110001cf62480efcf9a66bbf4819825a3f50e2bfa0ea');
    headers.putIfAbsent('Accept', ()=>'application/json, application/geo+json, application/gpx+xml, img/png; charset=utf-8');

    return _netUtil.postForMap('https://api.openrouteservice.org/v2/directions/driving-car/geojson',
        mbody: body,headers: headers
    ).then((res) {
      return res;
    });
  }
