...
class Translations {
  ...
  String confirm() => Intl.message('confirm',
      name: 'confirm', desc: 'Confirm Security Code');
  String register() => Intl.message('register',
      name: 'register', desc: 'register');
  String securitycode() => Intl.message('securitycode',
      name: 'securitycode', desc: 'securitycode');
  String help() => Intl.message('help',
      name: 'help', desc: 'Help');
  String search() => Intl.message('search',
      name: 'search', desc: 'search');
  String support() => Intl.message('support',
      name: 'support', desc: 'support');
  String login() => Intl.message('login',
      name: 'login', desc: 'login');
  String exit() => Intl.message('exit',
      name: 'exit', desc: 'exit');

  String basket() => Intl.message('basket',
      name: 'basket', desc: 'basket');
  String userName() => Intl.message('userName',
      name: 'userName', desc: 'userName');
  String home() => Intl.message('home',
      name: 'home', desc: 'home');
  String mobile() => Intl.message('mobile',
      name: 'mobile', desc: 'mobile');
  String phone() => Intl.message('phone',
      name: 'phone', desc: 'phone');
  String address() => Intl.message('address',
      name: 'address', desc: 'address');
  String firstName() => Intl.message('firstName',
      name: 'firstName', desc: 'firstName');
  String lastName() => Intl.message('lastName',
      name: 'lastName', desc: 'lastName');
  String age() => Intl.message('age',
      name: 'age', desc: 'age');
  String userinfo() => Intl.message('userinfo',
      name: 'userinfo', desc: 'userinfo');
  String deviceinfo() => Intl.message('deviceinfo',
      name: 'deviceinfo', desc: 'deviceinfo');
  String cartype() => Intl.message('cartype',
      name: 'cartype', desc: 'cartype');
  String carcolor() => Intl.message('carcolor',
      name: 'carcolor', desc: 'carcolor');
  String carfunction() => Intl.message('carfunction',
      name: 'carfunction', desc: 'carfunction');
  String caryear() => Intl.message('caryear',
      name: 'caryear', desc: 'caryear');
  String carmodel() => Intl.message('carmodel',
      name: 'carmodel', desc: 'carmodel');
  String carbtitle() => Intl.message('carbtitle',
      name: 'carbtitle', desc: 'carbtitle');
  String devicemobile() => Intl.message('devicemobile',
      name: 'devicemobile', desc: 'devicemobile');
  String password() => Intl.message('password',
      name: 'password', desc: 'password');
  String imei() => Intl.message('imei',
      name: 'imei', desc: 'imei');
  String simcartno() => Intl.message('simcartno',
      name: 'simcartno', desc: 'simcartno');
  String settings() => Intl.message('settings',
      name: 'settings', desc: 'settings');
  String on() => Intl.message('ON',
      name: 'on', desc: 'on');
  String off() => Intl.message('OFF',
      name: 'off', desc: 'off');
  String mobilename() => Intl.message('mobilename',
      name: 'mobilename', desc: 'mobilename');
  String pattern() => Intl.message('pattern',
      name: 'pattern', desc: 'pattern');
  String admin() => Intl.message('admin',
      name: 'admin', desc: 'admin');
  String edit() => Intl.message('edit',
      name: 'edit', desc: 'edit');
  String carbrand() => Intl.message('carbrand',
      name: 'carbrand', desc: 'carbrand');
  String carpelak() => Intl.message('carpelak',
      name: 'carpelak', desc: 'carpelak');
  String loadingdata() => Intl.message('loadingdata',
      name: 'loadingdata', desc: 'loadingdata');
  ...
  String send() => Intl.message('send',
      name: 'send', desc: 'send');
  String noimage() => Intl.message('noimage',
      name: 'noimage', desc: 'noimage');
  String dataloaded() => Intl.message('dataloaded',
      name: 'dataloaded', desc: 'dataloaded');
  String email() => Intl.message('email',
      name: 'email', desc: 'email');
  String profile() => Intl.message('profile',
      name: 'profile', desc: 'profile');
  String authToAccess() => Intl.message('authToAccess',
      name: 'authToAccess', desc: 'authToAccess');
  String car() => Intl.message('car',
      name: 'car', desc: 'car');
  String security() => Intl.message('security',
      name: 'security', desc: 'security');
  ...
  String no() => Intl.message('No',
      name: 'no', desc: 'no');
  String magicarTitle() => Intl.message('MAGICAR',
      name: 'magicarTitle', desc: 'magicarTitle');
  ...
  String cancel() => Intl.message('cancel',
      name: 'cancel', desc: 'cancel');
  String signInTitle() => Intl.message('signInTitle',
      name: 'signInTitle', desc: 'signInTitle');
  ...
  String lockOut() => Intl.message('lockOut',
      name: 'lockOut', desc: 'lockOut');
  String enable() => Intl.message('enable',
      name: 'enable', desc: 'enable');
  String disable() => Intl.message('disable',
      name: 'disable', desc: 'disable');
  String engineStart() => Intl.message('Start',
      name: 'engineStart', desc: 'engineStart');
  String darkTheme() => Intl.message('Dark',
      name: 'darkTheme', desc: 'darkTheme');
  String lightTheme() => Intl.message('Light',
      name: 'lightTheme', desc: 'lightTheme');
  String appTheme() => Intl.message('Current App Theme',
      name: 'appTheme', desc: 'appTheme');
  String withLogin() => Intl.message('Enter with Login',
      name: 'withLogin', desc: 'withLogin');
  String noLogin() => Intl.message('Enter with no Login',
      name: 'noLogin', desc: 'noLogin');
  ...
  String statusLogin() => Intl.message('Login Type',
      name: 'statusLogin', desc: 'statusLogin');
  String carsNo() => Intl.message('Cars Counts',
      name: 'carsNo', desc: 'carsNo');
  String counts() => Intl.message('Cars Counts',
      name: 'counts', desc: 'counts');
  ...
  String goBack() => Intl.message('Back',
      name: 'goBack', desc: 'goBack');
  ...
  String distance() => Intl.message('Distance',
      name: 'distance', desc: 'distance');
  String carTip() => Intl.message('Car Tip',
      name: 'carTip', desc: 'carTip');
  ...
  String users() => Intl.message('Users',
      name: 'users', desc: 'users');
  String noDatatoShow() => Intl.message('No Data to Show',
      name: 'noDatatoShow', desc: 'noDatatoShow');
  String useLogin() => Intl.message('Use Login',
      name: 'useLogin', desc: 'useLogin');
  String usePassword() => Intl.message('Use Password',
      name: 'usePassword', desc: 'usePassword');
  String useFingerPrint() => Intl.message('Use FingerPrint',
      name: 'useFingerPrint', desc: 'useFingerPrint');
  String usePattern() => Intl.message('Use Pattern',
      name: 'usePattern', desc: 'usePattern');
  String resetPassword() => Intl.message('Reset Password',
      name: 'resetPassword', desc: 'resetPassword');
  String currentPlan() => Intl.message('Current Plan',
      name: 'currentPlan', desc: 'currentPlan');
  String planCode() => Intl.message('Plan Code',
      name: 'planCode', desc: 'planCode');
  String planTitle() => Intl.message('Plan Title',
      name: 'planTitle', desc: 'planTitle');
  String invoiceDate() => Intl.message('Invoice Date',
      name: 'invoiceDate', desc: 'invoiceDate');
  String startDate() => Intl.message('Start Date',
      name: 'startDate', desc: 'startDate');
  String endDate() => Intl.message('End Date',
      name: 'endDate', desc: 'endDate');
  String active() => Intl.message('Active',
      name: 'active', desc: 'active');
  String deactive() => Intl.message('Deactive',
      name: 'deactive', desc: 'deactive');
  String planStatus() => Intl.message('Plan Status',
      name: 'planStatus', desc: 'planStatus');
  String planType() => Intl.message('Plan Type',
      name: 'planType', desc: 'planType');
  String errorInUIs() => Intl.message('Error in Null Widget...',
      name: 'errorInUIs', desc: 'errorInUIs');
  String errorInUIsDescription() => Intl.message('Error in Widget! Null Widget...',
  ...
  String plans() => Intl.message('Plans',
      name: 'plans', desc: 'plans');
  ...
  String plzEnterRecievedSecurityCode() => Intl.message('Enter Recieved SecurityCode',
      name: 'plzEnterRecievedSecurityCode', desc: 'plzEnterRecievedSecurityCode');
  String userCounts() => Intl.message('User Counts',
      name: 'userCounts', desc: 'userCounts');
  String resendSecurityCode() => Intl.message('Resend Code',
      name: 'resendSecurityCode', desc: 'resendSecurityCode');
  String fromDate() => Intl.message('From Date',
      name: 'fromDate', desc: 'fromDate');
  String cars() => Intl.message('Cars',
      name: 'cars', desc: 'cars');
  ...
  String resetPasswordUnSuccessful() => Intl.message('Reset Password UnSuccessful',
      name: 'resetPasswordUnSuccessful', desc: 'resetPasswordUnSuccessful');
  String sendingCommand() => Intl.message('Sending',
      name: 'sendingCommand', desc: 'sendingCommand');
  String sentCommand() => Intl.message('Sent',
      name: 'sentCommand', desc: 'sentCommand');
  ...
  String authorized() => Intl.message('Authorized',
      name: 'authorized', desc: 'authorized');
  ...
  String noCarExist() => Intl.message('No Car Exist',
      name: 'noCarExist', desc: 'noCarExist');
  String searchCar() => Intl.message('Search Car',
      name: 'searchCar', desc: 'searchCar');
  String currentPassword() => Intl.message('Current Password',
      name: 'currentPassword', desc: 'currentPassword');
  String plzWaiting() => Intl.message('Please Wait...',
      name: 'plzWaiting', desc: 'plzWaiting');
  String toDate() => Intl.message('To Date',
      name: 'toDate', desc: 'toDate');
  String planCost() => Intl.message('Plan Cost',
      name: 'planCost', desc: 'planCost');
  String buyPlan() => Intl.message('Buy Plan',
      name: 'buyPlan', desc: 'buyPlan');
  String invoiceAmount() => Intl.message('Invoice Amount',
      name: 'invoiceAmount', desc: 'invoiceAmount');
  String carId() => Intl.message('Car ID',
      name: 'carId', desc: 'carId');
  ...
  String roleTitle() => Intl.message('Role Title',
      name: 'roleTitle', desc: 'roleTitle');
  ...
  String rolesTitle() => Intl.message('Roles',
      name: 'rolesTitle', desc: 'rolesTitle');
  ...
  String activatePlan() => Intl.message('Activate Plan',
      name: 'activatePlan', desc: 'activatePlan');
  String planIsActive() => Intl.message('Plan Is Active',
      name: 'planIsActive', desc: 'planIsActive');
  String carTitle() => Intl.message('Title',
      name: 'carTitle', desc: 'carTitle');
  String carModelTitle() => Intl.message('Car Model',
      name: 'carModelTitle', desc: 'carModelTitle');
  ...
  String foundCar() => Intl.message('Found Car',
      name: 'foundCar', desc: 'foundCar');
  String appSettings() => Intl.message('App Settings',
      name: 'appSettings', desc: 'appSettings');
  String loadingLogin() => Intl.message('Loading Login',
      name: 'loadingLogin', desc: 'loadingLogin');
  String close() => Intl.message('Close',
      name: 'close', desc: 'close');
  String sendChanges() => Intl.message('Send Changes',
      name: 'sendChanges', desc: 'sendChanges');
  ...
  String routeCars() => Intl.message('Route Cars',
      name: 'routeCars', desc: 'routeCars');
  ...
  String carList() => Intl.message('Car List',
      name: 'carList', desc: 'carList');
  String joinCars() => Intl.message('Join Cars',
      name: 'joinCars', desc: 'joinCars');
  String report() => Intl.message('Report',
      name: 'report', desc: 'report');
  String enablePlan() => Intl.message('Enable',
      name: 'enablePlan', desc: 'enablePlan');
  String doFilter() => Intl.message('Do Filter',
      name: 'doFilter', desc: 'doFilter');
  String delete() => Intl.message('Delete',
      name: 'delete', desc: 'delete');
  String activateCar() => Intl.message('Activate',
      name: 'activateCar', desc: 'activateCar');
  String messageTitle() => Intl.message('Action',
      name: 'messageTitle', desc: 'messageTitle');
  String serviceDate() => Intl.message('Service Date',
      name: 'serviceDate', desc: 'serviceDate');
  String alarmDate() => Intl.message('Alarm Date',
      name: 'alarmDate', desc: 'alarmDate');
  String alarmCount() => Intl.message('Alarm Count',
      name: 'alarmCount', desc: 'alarmCount');
  String actionDate() => Intl.message('Action Date',
      name: 'actionDate', desc: 'actionDate');
  String serviceCost() => Intl.message('Service Cost',
      name: 'serviceCost', desc: 'serviceCost');
  ...
  String carJoindBefore() => Intl.message('Last Cars',
      name: 'carJoindBefore', desc: 'carJoindBefore');
  ...
  String messageDate() => Intl.message('Message Date',
      name: 'messageDate', desc: 'messageDate');
