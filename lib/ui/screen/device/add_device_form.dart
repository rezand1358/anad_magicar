       ...
       serviceResult.IsSuccessful)
         {
           if(serviceResult.Message!=null)
             centerRepository.showFancyToast(serviceResult.Message);
           else
              centerRepository.showFancyToast(Translations.current.registerSuccessful());
       ...
       else
         {
           if(serviceResult.Message!=null)
            centerRepository.showFancyToast(serviceResult.Message);
             ...
             centerRepository.showFancyToast(Translations.current.deviceNotAvailable());
